...
public class UnionTest {
	...
	private static final Object[] getUnionsAndPoints1() {
		...
		Point2D point1 = new Point2D.Double(0.01, 1.01);
		Point2D point2 = new Point2D.Double(4.5, 4);
		Point2D point3 = new Point2D.Double(6.99, 5.99);
		Point2D point4 = new Point2D.Double(5.99, 1.01);
		Point2D point5 = new Point2D.Double(6.99, 4.01);
	...
	private static final Object[] getUnionsAndPoints2() {
		...
		Point2D point4 = new Point2D.Double(5, 0.99);
