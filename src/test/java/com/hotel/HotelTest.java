...
public class HotelTest {
	...
	public void getCheapestQueryResults() {
		...
		Assert.assertEquals(true,
				qr1.get(0).getRooms().contains(new Room("room1")));
		Assert.assertEquals(true,
				qr4.get(0).getRooms().contains(new Room("room4")));
		...
		sampleQueryResult.setPrice(4 * sampleQueryResult.getRooms().get(0)
				.getPrice());
	...
	public void reserve() {
		...
		Assert.assertEquals("jan_nowak@gmail.com", hotel.getReservations().get(0).getPerson().getEmail());
		Assert.assertEquals("Krakow, ul. Nowakowska 31a", hotel.getReservations().get(0).getPerson().getAddress());
		...
		Assert.assertEquals("tomasz_poznanski@gmail.com", hotel.getReservations().get(2).getPerson().getEmail());
		Assert.assertEquals("Wroclaw, ul. Prokocimska 28n", hotel.getReservations().get(2).getPerson().getAddress());
		...
		Assert.assertEquals("adam_nawalka@pzpn.pl", hotel.getReservations().get(3).getPerson().getEmail());
		Assert.assertEquals("Warszawa, ul. Powstancow 40c", hotel.getReservations().get(3).getPerson().getAddress());
