...
public class Hotel implements HotelInt{
	...
	public List<QueryResult> getCheapest(List<QueryResult> results, long resultNr) {
	 ...
	 private List<QueryResult> getResults(int peopleNr, long nights) {
		 ...
		 List<QueryResult> rawResults = addResult(new ArrayList<Room>(), new ArrayList<Room>(getRooms()), 0, 0, peopleNr, new ArrayList<QueryResult>());
